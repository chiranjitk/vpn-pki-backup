 ...
 */
export function getPKIPaths(): PKIPaths {
  const swanctlBase = process.env.SWANCTL_BASE_PATH || '/etc/swanctl'
>>>>>>> cb3b2e1ec22a345a6b5378050327d37b6f83d124
...
=======
    // Client certificates (generated by this platform)
    clientCertsPath: process.env.PKI_CLIENT_CERTS_PATH || path.join(swanctlBase, 'x509'),
    clientKeysPath: process.env.PKI_CLIENT_KEYS_PATH || path.join(swanctlBase, 'private'),
    clientPkcs12Path: process.env.PKI_CLIENT_PKCS12_PATH || path.join(swanctlBase, 'pkcs12'),
    
    // CA certs directory for swanctl
    caCertsPath: path.join(swanctlBase, 'x509ca'),
    
    // strongSwan standard paths
>>>>>>> cb3b2e1ec22a345a6b5378050327d37b6f83d124
...
<<<<<<< HEAD
  ...
  try {
    ...
    // Ignore errors
=======
  // Private directory should be more restrictive
  if (!fs.existsSync(paths.swanctlPrivatePath)) {
    fs.mkdirSync(paths.swanctlPrivatePath, { recursive: true, mode: 0o700 })
>>>>>>> cb3b2e1ec22a345a6b5378050327d37b6f83d124
  }
}
